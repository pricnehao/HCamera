...
import com.haofugang.hfgcamera.internal.ui.preview.PreviewActivity;
import com.haofugang.hfgcamera.internal.ui.view.CameraControlPanel;
import com.haofugang.hfgcamera.internal.ui.view.CameraSwitchView;
import com.haofugang.hfgcamera.internal.ui.view.FlashSwitchView;
import com.haofugang.hfgcamera.internal.ui.view.MediaActionSwitchView;
import com.haofugang.hfgcamera.internal.ui.view.RecordButton;
...
public abstract class BaseAnncaActivity<CameraId> extends AnncaCameraActivity<CameraId>
    ...
    protected int currentCameraType = CameraSwitchView.CAMERA_TYPE_REAR;//相机的默认值 1 是后摄像头 0是前摄像头 和后面的不一样
    ...
    protected void onResume() {
        ...
        cameraControlPanel.lockControls(currentCameraType);
