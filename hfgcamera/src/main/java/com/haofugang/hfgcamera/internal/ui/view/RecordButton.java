...
import static com.haofugang.hfgcamera.internal.utils.Constant.MinRECTime;
 ...
 * 底部的录制按钮
 *
 * 这里修改CLICK_DELAY 这个值已达到小于10秒不能停止录制的需求
 */
...
//        setBackground(ContextCompat.getDrawable(context, R.drawable.circle_frame_background_dark));
    ...
    private class RecordClickListener implements OnClickListener {
        ...
        private final static int CLICK_DELAY = MinRECTime*1000;
        ...
        public void onClick(View view) {
            if (System.currentTimeMillis() - lastClickTime <= CLICK_DELAY) {
                ...
                {
                    Toast.makeText(getContext(),"录制时间不能小于"+(CLICK_DELAY/1000)+"s", Toast.LENGTH_SHORT).show();
                    return;
                }
